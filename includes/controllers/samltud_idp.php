...
/**  IdP Options
	*
	*  This function reads the IdP configuration file used by SimpleSAMLPHP and
	*  parses the configured IdPs.
...
// Fetch metadata from URL provided by user
if ( isset($_POST['fetch_metadata'])
	&& wp_verify_nonce($_POST['_wpnonce'], 'samltudidp_metadata') ) {
...
} elseif (isset($_POST['submit']) && wp_verify_nonce($_POST['_wpnonce'],'samltudidp_manual') ) {
  $contents = [];
...
include(constant('SAMLTUD_AUTH_ROOT') . '/includes/views/samltud_idp.php');
