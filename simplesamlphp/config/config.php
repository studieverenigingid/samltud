...
$config = array(
     ...
     * reverse proxy).
     */
    'baseurlpath' => ((defined('SAMLTUD_AUTH_URL')) ? SAMLTUD_AUTH_URL : '/wp-content/plugins/samltud') . '/simplesamlphp/www/',
    'certdir' => 'cert/generated/',
    'loggingdir' => 'log/',
    'datadir' => 'data/',
     ...
     */
    'secretsalt' => constant('SAMLTUD_SALT'),
     ...
     */
    'technicalcontact_name' => get_bloginfo('name') . ' Admin',
    'technicalcontact_email' => get_option('admin_email'),
